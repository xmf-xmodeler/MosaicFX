...
public enum SelfAssessmentTest {
	...
	GENERALIZATION_SPECIALIZATION_I("Construct Vehicle Generalization", LearningUnit.GENERALIZATION_SPECIALIZATION_I, 1),
	DEFICIENT_ATTRIBUTES("Identify Derivable Attributes - Movie Tickets", LearningUnit.DERIVED_CONCEPTS, 1);
