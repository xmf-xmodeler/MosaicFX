...
public class UserDataProcessor {
	...
	public static void appendSelfAssessmentTest(SelfAssessmentTest test) {
		...
		learningUnit.ifPresentOrElse(foundItem -> appendTest(doc, foundItem, test), () -> createNewLearningUnitObject(doc, learningUnit, test));
	}
	...
	private static void createNewLearningUnitObject(JsonObject doc, Optional<JsonObject> learningUnit, SelfAssessmentTest test) {
