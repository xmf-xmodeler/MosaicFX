...
public abstract class NodeBaseElement extends NodeElement {
	...
	@Override public final NodeBaseElement getHitElement(Point2D mouse, GraphicsContext g, Affine currentTransform, FmmlxDiagramView.DiagramViewPane diagramView) {
		if(isHit(mouse.getX(), mouse.getY(), diagramView))
			return this; return null;
	}
	
	@Override public final Action getAction(Point2D mouse, GraphicsContext g, Affine currentTransform, FmmlxDiagramView.DiagramViewPane diagramView) {
		if(isHit(mouse.getX(), mouse.getY(), diagramView))
			return this.action;
		return null;
	}	
