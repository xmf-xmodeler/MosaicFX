...
//				}
	...
	public void appendToDefaultGUI(FmmlxObject object) {
		...
		for(FmmlxSlot slot: object.getAllSlots()) {
			...
			rechteSeiteGrid.add(new Label(slot.getName()), 0, rechteSeiteGrid.getRowCount());
			rechteSeiteGrid.add( valueTextField, 1, rechteSeiteGrid.getRowCount()-1);
		}
		...
		for(FmmlxOperationValue operationValue: object.getAllOperationValues()) {
			...
			rechteSeiteGrid.add(new Label(operationValue.getName()), 0, rechteSeiteGrid.getRowCount());
			rechteSeiteGrid.add(valueTextField, 1, rechteSeiteGrid.getRowCount()-1);
		}
	}
