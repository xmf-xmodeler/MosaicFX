	...
	private void appendEdgesToDiagram(DiagramInfo diagramInfo, Element diagram) {
		...
		ReturnCall<HashMap<String, HashMap<String, Object>>> onAllEdgePositionsReceived = edgesData -> {
			...
			for (Entry<String, HashMap<String, Object>> edgeData : edgesData.entrySet()) {
				...
				@SuppressWarnings("unchecked")
				Vector<Vector<Object>> intermediatePointsData = (Vector<Vector<Object>>) attributesMap
				...
				Vector<String> edgeTypes = new Vector<>(Arrays.asList("Inheritance", "Delegation", "RoleFiller", "AssociationLink"));
...
comm.getAllLabelPositions(diagramInfo.getId(), onAllLabelPositionsReceived);
	...
	private void appendObjectPositionsToDiagram(DiagramInfo diagramInfo, Element diagram) {
		ReturnCall<HashMap<String, HashMap<String, Object>>> onAllObjectPositionsReceived = objectPositions -> {
			Element objects = XMLUtil.getChildElement(diagram, XMLTags.OBJECTS.getName());
		...
		comm.getAllObjectPositions(diagramInfo.getId(), onAllObjectPositionsReceived);
	}
	...
	private void createObjectElement(Element objects, java.util.Map.Entry<String, HashMap<String, Object>> objectPosition) {
		Element object =XMLUtil.createChildElement(objects, XMLTags.OBJECT.getName());
